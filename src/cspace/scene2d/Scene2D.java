...
public class Scene2D implements GLEventListener {
  ...
  public Scene2D(Scene scene) {
    ...
    camera.scale = scene.visuals.cameraVisuals.getScale2d();
    camera.center = scene.visuals.cameraVisuals.getCenter2d();
  }
  ...
  public void display(GLAutoDrawable drawable) {
    ...
    SampledSub ssub = cspace.scene3d.SubView.selected;
    if (ssub == null) {
      return;
    }
    Sub sub = ssub.sub;
