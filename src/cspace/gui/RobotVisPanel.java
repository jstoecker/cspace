...
public class RobotVisPanel extends JPanel {

  public RobotVisPanel(final RobotVisuals visuals) {
    ...
    gbc_cxbDrawOrigin.fill = GridBagConstraints.VERTICAL;
    ...
    final JCheckBox cxbUsePath = new JCheckBox("Use Path");
    cxbUsePath.setSelected(visuals.isOnPath());
    cxbUsePath.addChangeListener(new ChangeListener() {
      public void stateChanged(ChangeEvent e) {
        visuals.setOnPath(cxbUsePath.isSelected());
      }
    });
    cxbUsePath.setHorizontalTextPosition(SwingConstants.LEFT);
    GridBagConstraints gbc_cxbUsePath = new GridBagConstraints();
    gbc_cxbUsePath.fill = GridBagConstraints.VERTICAL;
    gbc_cxbUsePath.anchor = GridBagConstraints.EAST;
    gbc_cxbUsePath.gridwidth = 2;
    gbc_cxbUsePath.gridx = 0;
    gbc_cxbUsePath.gridy = 6;
    add(cxbUsePath, gbc_cxbUsePath);
  }
}
